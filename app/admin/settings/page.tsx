...
export default function SettingsPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // Fetch Profile
                const profileRes = await fetch(`/backend/get-admin-profile.php`, { credentials: "include" });
                ...
                const settingsRes = await fetch(`/backend/get-system-settings.php`, { credentials: "include" });
    ...
    const handleUpdateProfile = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch(`/backend/update-admin-profile.php`, {
                method: "POST",
                credentials: "include",
    ...
    const handleSaveNavSettings = async (e: React.FormEvent) => {
        ...
        setNavUpdating(true);
        try {
            const res = await fetch(`/backend/update-system-settings.php`, {
                method: "POST",
                credentials: "include",
                headers: { "Content-Type": "application/json" },
