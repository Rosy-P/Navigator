...
const res = targets.map(t => {
    ...
    return { id: t.id, target: t.c, nearest: best };
});
fs.writeFileSync('c:\\Users\\acer\\OneDrive\\Documents\\project\\Navigator\\scripts\\arts_nearest.json', JSON.stringify(res, null, 2));
console.log('Results saved to arts_nearest.json');
